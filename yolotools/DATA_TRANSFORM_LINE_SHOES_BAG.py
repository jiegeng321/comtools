...
white_sample_dir_list["/data01/xu.fx/dataset/SHOES_BAG_DATASET/white_data/handbag_white"] = 5000
white_sample_dir_list["/data01/xu.fx/dataset/SHOES_BAG_DATASET/white_data/footwear_white"] = 3500
white_sample_dir_list["/data01/xu.fx/dataset/SHOES_BAG_DATASET/white_data/empty_white"] = 8000
...
MAX_OBJ_NUM_PER_BRAND = None
#WHITE_SAMPLE_COUNT = 0
detect_num = None#2
export_data_info_csv = True
WORKERS = 20

main_data_dir = "dataset/SHOES_BAG_DATASET/comb_data"
yolo_dataset_name = "yolodataset_shoes_bag_2bs_2ks_0907"

CLASS_list = ['footwear', 'handbag']
brand_names = []
for c in CLASS_list:
    brand = c.split("-")[0]
...
eval_img_path = "/data01/xu.fx/dataset/SHOES_BAG_DATASET/fordeal_test_data/images"
eval_xml_path = "/data01/xu.fx/dataset/SHOES_BAG_DATASET/fordeal_test_data/labels_xml"
