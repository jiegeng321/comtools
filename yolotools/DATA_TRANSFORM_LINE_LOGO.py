...
white_sample_dir_list["/data01/xu.fx/dataset/LOGO_DATASET/white_data/fordeal误检数据0705"] = 2500
...
yolo_dataset_name = "yolodataset_logo_784bs_1393ks_0810"
...
quit_list = ["Maserati-3","Sephora-1","Chicago White Sox-3","Bang Olufsen-w-1","PUMA-w-1","AS Roma-w-2","Alpinestars-w-3",
             ...
             "Cartier-w-2","New Era-w-1","Samantha Thavasa-2","Def Leppard-w-2"
             ]
D11 = ["Aeronautica Militare-1","Aeronautica Militare-w-2","Baume et Mercier-w-1","Baume et Mercier-2","Beachbody-w-1","Beachbody-2",
       "France-1","France-2","Golds Gym-w-1","Golds Gym-2","Golds Gym-3","Nintendo-w-1","Spibelt-1","Spibelt-2","Snow White-1"]
