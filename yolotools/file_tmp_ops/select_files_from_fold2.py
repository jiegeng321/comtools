...
be_deleted_dir = "/data01/xu.fx/dataset/NEW_RAW_INCREASE_DATA/已完成-白样本误检测试check任务-logo/"
src_dir = "/data01/xu.fx/dataset/LOGO_DATASET/fordeal_test_data_total/white_test_labeled/empty"
move_to_dir = check_dir("/data01/xu.fx/dataset/NEW_RAW_INCREASE_DATA/tmp/")
...
for de in tqdm(be_deleted):
    #print(de)
    if "误检" not in str(de.parent.name):
        #get+=1
        continue
    #get1+=1
    #print(str(de))
