...
label_path = './card_cerd_final_test_2th_label'
predict_path = './card_cerd_final_test_2th_predict'
...
for i in range(0, len(list_path_real)):
    ...
    path_our = os.path.join(predict_path, list_path_real[i].split('.')[0]+'_main.txt')
    ...
    if r[0] == p[0]:
        ...
        print(lines_r)
        print(lines_p)
        print('name_diff:',list_path_real[i])
    if r[1] == p[1]:
        Idnum_count_our+=1
    else:
        print(lines_r)
        print(lines_p)
        print('idnum_diff:',list_path_real[i])
    if r[2] == p[2]:
        Date_count_our+=1
    else:
        print(lines_r)
        print(lines_p)
        print('date_diff:',list_path_real[i])
    if r[3] == p[3]:
        Date_start_count_our+=1
    else:
        print(lines_r)
        print(lines_p)
        print('satrt_date_diff:',list_path_real[i])
