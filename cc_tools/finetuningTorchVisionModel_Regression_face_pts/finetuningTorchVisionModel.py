...
from my_datasets import DatasetImgTxtPair
...
data_dir = "/home/admin/data/xfeng/COMDATA/face_pts_train_data/face_pts_train_data_torch_final_no_open"
save_model_dir = '/home/admin/data/xfeng/COMMODEL/face_pts_20th_with_init_final_no_open_small2/'
model_name = "my_resnet"  # 从[my_resnet,resnet, alexnet, vgg, squeezenet, densenet, inception]中选择模型
pretrain_model = "/home/admin/data/xfeng/COMMODEL/face_pts_20th_with_init_final_no_open_small2/best_acc.pt"
#mod = torch.load("/home/admin/data/xfeng/COMMODEL/face_pts_16th_with_init_norm_comb3_rot/best_acc.pth")
#torch.save(mod.state_dict(),"./pretrain_model_222.pth")

#pretrain_model = "./pretrain_model_222.pth"
#pretrain_model = None
layers = [1,1,1]
input_size = 144 
num_classes = 44 
   ...
   for epoch in range(num_epochs):
       ...
       for phase in ['train', 'val']:
           ...
           if (phase == 'val' and epoch_loss < best_loss):#epoch_acc > best_acc
               ...
               best_acc = epoch_acc
               best_model_wts = copy.deepcopy(model.state_dict())
               torch.save(model.state_dict(), save_model_dir+'best_acc.pt')
