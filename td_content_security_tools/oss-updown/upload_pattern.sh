...
python3 updown_model.py --action upload \
                    --bucket ai_vision\
                    --local /data01/xu.fx/my_app/p40_model/20220623_yolov5_pattern_18bs_26ks_P40.trt \
                    --remote ai-brand-pattern/1.2/20220623_yolov5_pattern_18bs_26ks_P40.trt
...
python3 updown_model.py --action upload \
                    ...
                    --remote ai-brand-pattern/1.2/config.py
