...
export MODEL_REMOTE_PATH=${APPNAME}/1.0/20220314_yolov5m_brand776_style1376_P40.trt
export MODEL_REMOTE_PATH_T4=${APPNAME}/1.0/20220314_yolov5m_brand776_style1376_T4.trt
export CONFIG_REMOTE_PATH=${APPNAME}/1.0/config.py
