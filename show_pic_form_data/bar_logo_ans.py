...
support_brand_pic_num = 0
cate_not_support = []
data_not_support = []

for i in logo_dict:
    support_brand_pic_num += i[1]
...
print("total pic num:",support_brand_pic_num)
